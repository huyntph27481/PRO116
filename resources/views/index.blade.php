        ...
        <div class="furniture--4 border--round arrows_style owl-carousel owl-theme mt--50">
            ...
            <div class="product product__style--3">
                <div class="product__thumb">
                    <a class="first__img" href="{{ route('book.detail', $data->id) }}"><img style="height: 300px ; " src="{{ asset('storage/book/' . $data->book_image) }}" alt="product image"></a>


                </div>
                <div class="product__content content--center">
                    <h4><a href="single-product.html">{{$data->title_book}}</a></h4>
                    <ul class="price d-flex">
                        <li>{{$data->price}}</li>
                        <li class="old_price">{{$data->original_price}}</li>
                    </ul>
                    <div class="action">
                        <div class="actions_inner">
                            <ul class="add_to_links">
                                ...
                                <li><a class="quickview modal-view detail-link" href="{{ route('book.detail', $data->id) }}"><i class="bi bi-search"></i></a></li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-7 offset-lg-5 col-md-12 col-12 ptb--150">
                ...
                <div class="newsletter__block text-center">
                    <p>Đăng ký nhận bản tin của chúng tôi ngay bây giờ và luôn cập nhật các bộ sưu tập mới, lookbook mới nhất và các ưu đãi độc quyền.</p>
                    <form action="#">
...
<section class="wn__recent__post style-two ptb--80">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="section__title text-center">
                    <h2 class="title__be--2">Blog <span class="color--theme">của chúng tôi</span></h2>
